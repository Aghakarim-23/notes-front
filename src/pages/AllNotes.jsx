...
const AllNotes = () => {
  ...
  return (
        <>
                ...
                <h1 className='text-center pt-9 md:pt-12 text-xl ml-8 md:text-2xl'>All shared notes with username</h1>
                    ...
                    >
                        <div className='flex flex-col gap-4 cursor-pointer '>
                            ...
                            <div className='flex justify-between'>
                                <span className='font-medium italic'>{notes.userId?.username}</span>
                                <span className='font-medium text-gray-400'>{new Date(notes.createdAt).toLocaleDateString()}</span>
                            </div>
                            <p className='text-center'>{notes.title}</p>
